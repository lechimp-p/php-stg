...
class LetBinding extends Pattern
{
    ...
    public function compile(Compiler $c, Gen $g, &$let_binding)
    {
        ...
        return $c->results()
            ->add_statements(array_flatten(array_map(function (Lang\Binding $binding) use ($g, &$class_names) {
            ...
            ->adds(array_flatten(array_map(function (Lang\Binding $binding) use ($c, $g, &$class_names) {
