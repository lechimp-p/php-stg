...
class LetRecBinding extends Pattern
{
     ...
     * @inheritdoc
     */
    public function compile(Compiler $c, Gen $g, &$letrec_binding) : Results
    {
        ...
        return $c->results()
            ->add_statements(
                array_flatten(
                    ...
                    array_map(
                        function (Lang\Binding $binding) use ($g, &$class_names) {
                            ...
                            return array_flatten(
                                ...
                                array_map(
                                    function (Lang\Variable $free_var) use ($g, $name) {
                                        $fname = $free_var->name();
            ...
            ->adds(
                array_flatten(
                    array_map(
                        function (Lang\Binding $binding) use ($c, $g, &$class_names) {
